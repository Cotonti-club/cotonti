...
<div class="card">
    <div class="card-body">
        <h5 class="card-title">{PHP.L.Modules}</h5>
        <table class="table">
...
<div class="block button-toolbar">
    ...
    <a href="{ADMIN_PAGE_STRUCTURE_RESYNCALL}" class="ajax button special"
...
<div class="block">
        ...
        <table class="cells">
            ...
            <tr>
                ...
                <td class="action {ADMIN_STRUCTURE_ODDEVEN}">
                    <a title="{PHP.L.Options}" href="{ADMIN_STRUCTURE_OPTIONS_URL}"
                       class="ajax button">{PHP.L.short_config}</a>
                    <!-- IF {ADMIN_STRUCTURE_RIGHTS_URL} --><a title="{PHP.L.Rights}"
                                                               href="{ADMIN_STRUCTURE_RIGHTS_URL}"
                                                               class="button">{PHP.L.short_rights}</a><!-- ENDIF -->
                    <!-- IF {PHP.dozvil} --><a title="{PHP.L.Delete}" href="{ADMIN_STRUCTURE_UPDATE_DEL_URL}"
                                               class="confirmLink button">{PHP.L.short_delete}</a><!-- ENDIF -->
                    <a href="{ADMIN_STRUCTURE_JUMPTO_URL}" title="{PHP.L.Pages}"
                       class="button special">{PHP.L.short_open}</a></td>
            </tr>
            <!-- END: ROW -->
            <tr>
    ...
    <p class="paging">{ADMIN_STRUCTURE_PAGINATION_PREV}{ADMIN_STRUCTURE_PAGNAV}{ADMIN_STRUCTURE_PAGINATION_NEXT}
        <span>{PHP.L.Total}: {ADMIN_STRUCTURE_TOTALITEMS}, {PHP.L.Onpage}: {ADMIN_STRUCTURE_COUNTER_ROW}</span></p>
</div>
<!-- END: DEFAULT -->
