...
<div class="row">
    <div class="col">
        <ul class="block">
            ...
            <!-- IF {PHP.cfg.forums} -->
            <li>{PHP.R.icon_rss} <a href="{PHP|cot_url('rss','m=forums')}"
                                    title="{PHP.L.RSS_Feeds} {PHP.cfg.separator} {PHP.L.Forums}"> RSS (<span
                            class="lower">{PHP.L.Forums}</span>)</a></li>
            <!-- ENDIF -->
            <!-- ENDIF -->
            <li class=""><a href="http://www.seditio.by" title="Free and Commercial Cotonti Themes and Plugins">Nemesis
                    Theme by Seditio.by</a></li>
        </ul>
    </div>
    <div class="col">
        <ul class="block">
    ...
    <div class="col">
        <ul id="account" class="block">
            ...
            <!-- END: GUEST -->
            <!-- BEGIN: USER -->
            <li><strong>Hello, {PHP.usr.name} <!-- IF {PHP.usr.maingrp} == 5 --> &nbsp; [ <a
                            href="{PHP|cot_url('admin')}" class="lower">{PHP.L.Adminpanel}</a> ]<!-- ENDIF --></strong>
            </li>
    ...
    <div class="col">
        ...
        <div id="magnifier">
            <form id="search" action="{PHP|cot_url('plug','e=search')}" method="post">
                <p>
                    <input type="text" name="sq" value="{PHP.L.Search}..."
